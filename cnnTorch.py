...
h2 = 50
h3 = 10
model.add(Dense(units= h1, activation='relu', input_dim=2))
model.add(Dense(units= h2, activation='relu', input_dim= h1))
model.add(Dense(units= h3, activation='relu', input_dim= h2))
model.add(Dense(units=1, activation='sigmoid', input_dim= h3))
